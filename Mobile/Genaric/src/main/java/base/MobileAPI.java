...
public class MobileAPI {
    ...
    public void setUp(@Optional("android")String OS, @Optional("mobile") String appType, @Optional("real device") String deviceType,
        ...
        if (OS.equalsIgnoreCase("ios")){
            if (appType.contains("iPhone")){
                ...
                findApp = new File(appDirectory,"/Users/imrankabir/IdeaProjects/MobileAutomation/UiCatalog/src/app/UICatalog6.1.app.zip");
    ...
    public AppiumDriver setUpiOsEnv(String deviceName,String version)throws IOException{
        DesiredCapabilities capabilities = new DesiredCapabilities();
        capabilities.setCapability(MobileCapabilityType.DEVICE_NAME, deviceName);
        capabilities.setCapability(MobileCapabilityType.PLATFORM_NAME, MobilePlatform.IOS);
        capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, version);
        capabilities.setCapability(MobileCapabilityType.APP, findApp.getAbsolutePath());
